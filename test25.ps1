...
# Configuration
$ShutdownHour = 08           # Specify the hour for shutdown (24-hour format)
$ShutdownMinute = 10    # Specify the minute for shutdown
$WarningMinutesBefore = 10   # Show warning 20 mins before shutdown, this can be adjusted.
