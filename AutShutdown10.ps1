...
$IntendedShutdownHour = 12    # Shutdown time hour (24-hour format)
$IntendedShutdownMinute = 25  # Shutdown time minute

$WarningOffsetMinutes = 20   # Minutes before shutdown to show the warning pop-up, can be adjusted

# Message details
$MessageTitle = "System Shutdown Warning!"
$MessageText = "Your computer is scheduled for an important action in approximately 20 minutes. Please save your work immediately."
...
try {
    ...
    $warningPrincipal = New-ScheduledTaskPrincipal -UserId "SYSTEM" -LogonType ServiceAccount -RunLevel Highest
